	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EnrouteV1beta1().IngressRoutes(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EnrouteV1beta1().IngressRoutes(namespace).Watch(options)
			},
		},
		&enroutev1beta1.IngressRoute{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *ingressRouteInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&enroutev1beta1.IngressRoute{}, f.defaultInformer)
}
