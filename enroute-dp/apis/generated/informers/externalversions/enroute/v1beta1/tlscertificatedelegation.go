	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EnrouteV1beta1().TLSCertificateDelegations(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EnrouteV1beta1().TLSCertificateDelegations(namespace).Watch(context.TODO(), options)
			},
		},
		&enroutev1beta1.TLSCertificateDelegation{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *tLSCertificateDelegationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&enroutev1beta1.TLSCertificateDelegation{}, f.defaultInformer)
}
