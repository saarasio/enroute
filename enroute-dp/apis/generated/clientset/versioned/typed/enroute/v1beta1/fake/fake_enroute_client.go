...
import (
	v1beta1 "github.com/saarasio/enroute/enroute-dp/apis/generated/clientset/versioned/typed/enroute/v1beta1"
	rest "k8s.io/client-go/rest"
	testing "k8s.io/client-go/testing"
)

type FakeEnrouteV1beta1 struct {
	*testing.Fake
}
...
func (c *FakeEnrouteV1beta1) TLSCertificateDelegations(namespace string) v1beta1.TLSCertificateDelegationInterface {
	return &FakeTLSCertificateDelegations{c, namespace}
}

// RESTClient returns a RESTClient that is used to communicate
// with API server by this client implementation.
func (c *FakeEnrouteV1beta1) RESTClient() rest.Interface {
