...
func (c *Client) runWithPostFields(ctx context.Context, req *Request, gr *bytes.Buffer) error {
	...
	// Create a request with a multipart message body
	r, err := http.NewRequest(http.MethodPost, c.endpoint, &requestBody)
	if err != nil {
		return err
	}
	r.Close = c.closeReq
	// Set headers for multipart request body
...
func (c *Client) Run(ctx context.Context, req *Request, gr *bytes.Buffer) error {
	...
	if c.useMultipartForm {
		return c.runWithPostFields(ctx, req, gr)
	}
	return c.runWithJSON(ctx, req, gr)
}

func (c *Client) runWithJSON(ctx context.Context, req *Request, buf *bytes.Buffer) error {
	var requestBody bytes.Buffer
